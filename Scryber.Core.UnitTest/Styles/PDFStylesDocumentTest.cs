...
namespace Scryber.Core.UnitTests.Styles
{
    ...
    public class PDFStylesDocumentTest
    {
        ...
        public void MapPathTest()
        {
            ...
            Assert.Inconclusive("The map path in styles needs sorting to the file path services provider");

            PDFStylesDocument target = new PDFStylesDocument();
            string path = @"..\Images\MyImage.png";
            string expected = @"C:\Documents\Images\MyImage.png";
            string src = @"C:\Documents\PDFs\MyStyles.pdfx";
            ...
            path = @"../Images/MyImage.png";
            expected = @"C:\Documents\Images\MyImage.png";
            src = @"C:\Documents\PDFs\MyStyles.pdfx";
            target.LoadedSource = src;
            ...
            path = @"C:\Images\MyImage.png";
            expected = @"C:\Images\MyImage.png";
            src = @"C:\Documents\PDFs\MyStyles.pdfx";
            target.LoadedSource = src;
        ...
        public void MapPathTest1()
        {
            ...
            // and a file path test

            source = @"../Images/MyImage.png";
            expected = @"C:\Documents\Images\MyImage.png";
            isfileExpected = true;
            target.LoadedSource = @"C:\Documents\PDFs\MyStyles.pdfx";
