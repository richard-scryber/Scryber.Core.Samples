...
namespace Scryber
{
    internal class BindingQueryStringExpressionFactory : IPDFBindingExpressionFactory
    {
        public string BindingKey { get { return "qs"; } }
        ...
        public PDFInitializedEventHandler GetInitBindingExpression(string expressionvalue, Type classType, System.Reflection.PropertyInfo forProperty)
        {
            ...
            BindingQueryStringExpression expr = BindingQueryStringExpression.Create(expressionvalue, conv, forProperty);
